...
export default function CartPage() {
  ...
  return (
    <div className="min-h-screen pb-32">
      <header className="sticky top-0 z-10 flex items-center gap-2 border-b border-gray-200 bg-tg-bg px-4 py-3">
        <Link
          href="/catalog"
          className="tap-highlight flex min-h-[44px] min-w-[44px] shrink-0 items-center justify-center rounded-full text-tg-text active:opacity-80"
          aria-label="В меню"
        >
        ...
        <h1 className="min-w-0 flex-1 text-xl font-bold text-tg-text">Корзина</h1>
        <Link
          href="/catalog"
          className="tap-highlight shrink-0 rounded-lg bg-tg-secondary px-3 py-2 text-sm font-medium text-tg-text active:opacity-90"
        >
          В меню
        </Link>
      </header>
